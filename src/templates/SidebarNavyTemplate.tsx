...
export const SidebarNavyTemplate: React.FC<ITemplateProps> = ({
  ...
  return (
    <div
      id="resume-sheet"
      className="w-full bg-white text-[#333333] flex shadow-paper print:shadow-none min-h-[1056px] text-[11px] leading-relaxed select-text"
      style={{ fontFamily: "'Open Sans', Arial, sans-serif" }}
    >
      {/* LEFT SIDEBAR (32%) */}
      <aside
        className="w-[32%] text-white p-7 flex flex-col gap-6 shrink-0 print:bg-[#0b2545]"
      ...
      <main className="w-[68%] p-8 flex flex-col gap-5 shrink-0">
        {/* Profile Summary */}
        {sectionVisibility.profile !== false && profileSummary && (
          <section
            id="preview-section-summary"
            onClick={() => setActiveSection('summary', 'preview')}
            className={`break-inside-avoid cursor-pointer rounded-xl p-2.5 -m-2.5 transition-all ${
          ...
          >
            ...
            <div className="flex flex-col gap-3.5 pl-0.5">
              {educationList.map((edu, index) => (
                <div key={edu.identifier || index} className="grid grid-cols-[76px_12px_1fr] gap-x-2 text-[10.5px] break-inside-avoid">
                  {/* Date Column */}
          ...
          >
            ...
            <div className="flex flex-col gap-3.5 pl-0.5">
              {projectsList.map((proj, index) => (
                <div key={proj.identifier || index} className="grid grid-cols-[76px_12px_1fr] gap-x-2 text-[10.5px] break-inside-avoid">
                  {/* Date Column */}
                  <div className="text-right font-semibold text-[#333333] text-[10px] leading-tight pt-0.5">
                    <EditableText
          ...
          >
            ...
            <div className="flex flex-col gap-3.5 pl-0.5">
              {experienceList.map((exp, index) => (
                <div key={exp.identifier || index} className="grid grid-cols-[76px_12px_1fr] gap-x-2 text-[10.5px] break-inside-avoid">
                  {/* Date Column */}
                  <div className="text-right font-semibold text-[#333333] text-[10px] leading-tight pt-0.5">
                    <EditableText
          ...
          >
            ...
            <div className="flex flex-col gap-3 pl-0.5">
              {sec.items.map((item, itemIdx) => (
                <div key={item.identifier || itemIdx} className="pl-8 text-[10.5px]">
