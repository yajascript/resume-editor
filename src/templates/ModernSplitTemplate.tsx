...
export const ModernSplitTemplate: React.FC<ITemplateProps> = ({
  ...
  return (
    <div
      id="resume-sheet"
      className="w-full bg-white text-slate-800 shadow-paper print:shadow-none min-h-[1056px] text-[11px] leading-relaxed select-text"
    ...
    >
      ...
      {/* Two Column Body */}
      <div className="p-8 grid grid-cols-[65%_35%] gap-8">
        {/* Main Column */}
            ...
            >
              ...
              <div className="flex flex-col gap-4">
                {experienceList.map((exp, index) => (
                  <div key={exp.identifier || index} className="flex flex-col gap-1">
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                {educationList.map((edu, index) => (
                  <div key={edu.identifier || index} className="flex flex-col gap-0.5">
