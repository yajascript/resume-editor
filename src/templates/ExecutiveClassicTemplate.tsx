...
export const ExecutiveClassicTemplate: React.FC<ITemplateProps> = ({
  ...
  return (
    <div
      id="resume-sheet"
      className="w-full bg-white text-slate-900 p-12 flex flex-col gap-5 shadow-paper print:shadow-none min-h-[1056px] text-[11px] leading-normal select-text"
        ...
        >
          ...
          <div className="flex flex-col gap-2.5">
            {educationList.map((edu, index) => (
              <div key={edu.identifier || index} className="flex justify-between items-baseline">
                <div>
                  <span className="font-bold text-[11px]">
                    <EditableText
