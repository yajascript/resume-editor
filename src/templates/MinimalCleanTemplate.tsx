...
export const MinimalCleanTemplate: React.FC<ITemplateProps> = ({
  ...
  return (
    <div
      id="resume-sheet"
      className="w-full bg-white text-[#1f2937] p-10 flex flex-col gap-6 shadow-paper print:shadow-none min-h-full h-full text-[11px] leading-normal select-text flex-1"
